...
> Sends your WooCommerce invoices to the Spanish Tax Agency (AEAT) under the Verifactu e-invoicing regulation (RD 1007/2023). Automatic, signed, sandbox-tested.
...
```bash
# Via WP-CLI
wp plugin install https://almc.es/downloads/almc-verifactu-1.0.0.zip --activate
```
